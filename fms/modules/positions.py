...
class RotaryEmbedding(PositionEncoder):
    ...
    def compute_freqs_cis(self, device, max_seq_len=2048):
        ...
        use_hardcoded_rope = False
        if use_hardcoded_rope:
            print("SAHIL: USING HARDCODED ROPE FREQS FOR LLAMA3-405B IN fms/modules/positions.py")
            freqs = torch.tensor(
            ...
            print("SAHIL: NOT USING HARDCODED ROPE FREQS FOR LLAMA3-405B IN fms/modules/positions.py")
            freqs = 1.0 / (
                ratio
